...
func TestCompilerScopes(t *testing.T) {
	...
	penultimateInstruction := compiler.scopes[compiler.scopeIndex].penultimateInstruction
	if penultimateInstruction.Opcode != code.OpMul {
		t.Errorf("penultimateInstruction.Opcode wrong. got=%d, want=%d",
			penultimateInstruction.Opcode, code.OpMul)
	}
}
